...
public class Resuelve {
	...
	private String nombreCrucigrama;
	...
	public String getNombreCrucigrama() {
		return nombreCrucigrama;
	}
	public void setNombreCrucigrama(String nombreCrucigrama) {
		this.nombreCrucigrama = nombreCrucigrama;
	}
