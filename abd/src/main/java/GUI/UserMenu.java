...
public class UserMenu {
	...
	public UserMenu(final DataSource ds, final User user) {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				CrosswordGUI opencrossword = new CrosswordGUI(words, ds, user,
						resuelve);
			}
		});
		...
		// creamos un mapper de los crucigramas activosactivos, y hacemos 2
		// busquedas, una por el nick del primer amigo como clave y otra por la
		// del segundo como clave
	...
	private void addUserInterface(JFrame frame, User user) {
		...
		if (user.getPicture() != null)
			btnNewButton_12.setIcon(user.getPicture());
